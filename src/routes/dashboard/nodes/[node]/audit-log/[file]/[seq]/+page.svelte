...
<Breadcrumb node={nodeId} pages={[
  ...
  { pageName: parsedHead || `Seq ${parsedSeq}` }
]} />
<h1 class="page-title">{parsedHead || `Frame ${parsedSeq}`}</h1>

{#if loading}
  <div class="loading-box"><span class="loading-spinner"></span></div>
{:else if !frameData}
  <div class="card" style="padding:40px;text-align:center;color:var(--text-muted)">No frame data found</div>
{:else}
    ...
    <div class="detail-content">
      {#if frags && frags.length > 0}
        ...
        <div class="nav-bar">
          ...
          <span class="nav-seq">Seq: {currentSeq}</span>
      ...
      {:else}
        ...
        <div class="raw-data-section">
          <div class="raw-data-header">Data Definition</div>
          <div class="raw-data-content">
            <pre>{frameData?.data || 'No data available'}</pre>
          </div>
        </div>
      {/if}
    </div>
    ...
    <div class="detail-sidebar">
      <div class="sidebar-card">
        ...
        <div class="sidebar-header">
          ...
          <span class="sidebar-label">Filename</span>
        </div>
        <div class="sidebar-value-large">{file}</div>

        <div class="fading-divider"></div>

        <div class="sidebar-section-title">Audit Log List</div>
        ...
        <div class="info-box">
          <div class="info-box-header">
            <span class="info-label">Max Frame Seq</span>
        ...
        <div class="frame-detail-panel">
          <span class="sidebar-section-title" style="padding:0;margin-bottom:8px">Audit Log Frame Detail</span>

          <!-- Seq (highlighted) -->
          <div class="info-box info-box-primary">
            <span class="info-label">Seq</span>
