      ...
      <div class="card" style="padding: 12px;">
        ...
        <div class="table-scroll">
          <table>
            <thead>
              <tr>
                <th style="text-align:right">Frame Seq</th>
            ...
            <tbody>
              {#if frameList.length === 0}
                <tr><td colspan="4" class="empty-cell">No frames found</td></tr>
              {:else}
    ...
    <div class="frame-sidebar">
      <div class="sidebar-card">
        ...
        <div class="frame-nav-panel">
          <span class="sidebar-section-title" style="margin-bottom:8px">Audit Log Frame Detail</span>
          <div class="frame-seq-input-group">
            <label class="field-label">Frame Seq</label>
            <input
              type="number"
              class="frame-seq-input"
              bind:value={frameSeqInput}
              on:keydown={handleFrameSeqKeydown}
              placeholder="Enter seq and press Enter"
            />
          </div>
        </div>
      </div>
