...
{:else if !item}
  <div class="card" style="padding:40px;text-align:center;color:var(--text-muted)">Rule not found</div>
{:else}
  <div class="detail-grid">
    <div class="card detail-card">
      ...
      <div class="field-list">
        ...
        <div class="field-row"><span class="field-label">Ref. Actions</span><span class="field-value">{item.ref_actions ?? '—'}</span></div>
